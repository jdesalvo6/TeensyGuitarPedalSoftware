...
void BTParamChanger(char eff)
{
  char rc;
  bool effectLooper = true;
  bool looper = true;
  char param;
  while(effectLooper)
  {
    ...
    if (eff == '1')
    {
      ...
      else if (param == '2')
      {
        ...
        while(looper)
        {
          ...
          if (rc == 'p' == LOW && flangeDepth < maxDepth)
          {
            Serial.println("right");
            flangeDepth = flangeDepth + 10;
            Serial.println(flangeDepth);
